...
/**
 * Pure turn-based combat resolution. Persistence and inventory side-effects stay in the
 * application layer.
 */
public final class CombatEngine {

	public record ActionContext(boolean potionAvailable, int potionHealAmount) {
	}
